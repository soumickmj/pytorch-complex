...
class MaxPool1d(_MaxPoolNd):
    ...
    def forward(self, input: Tensor) -> Tensor:
        return cF.complex_fcaller(F.max_pool1d, input, self.kernel_size, self.stride,
...
class MaxPool2d(_MaxPoolNd):
    ...
    def forward(self, input: Tensor) -> Tensor:
        return cF.complex_fcaller(F.max_pool2d, input, self.kernel_size, self.stride,
                                    self.padding, self.dilation, self.ceil_mode,
                                    self.return_indices)
...
class MaxPool3d(_MaxPoolNd):
    ...
    def forward(self, input: Tensor) -> Tensor:
        return cF.complex_fcaller(F.max_pool3d, input, self.kernel_size, self.stride,
                                    self.padding, self.dilation, self.ceil_mode,
                                    self.return_indices)
...
class MaxUnpool1d(_MaxUnpoolNd):
    ...
    def forward(self, input: Tensor, indices: Tensor, output_size: Optional[List[int]] = None) -> Tensor:
        return cF.complex_fcaller(F.max_unpool1d, input, indices, self.kernel_size, self.stride,
...
class MaxUnpool2d(_MaxUnpoolNd):
    ...
    def forward(self, input: Tensor, indices: Tensor, output_size: Optional[List[int]] = None) -> Tensor:
        return cF.complex_fcaller(F.max_unpool2d, input, indices, self.kernel_size, self.stride,
                                    self.padding, output_size)
...
class MaxUnpool3d(_MaxUnpoolNd):
    ...
    def forward(self, input: Tensor, indices: Tensor, output_size: Optional[List[int]] = None) -> Tensor:
        return cF.complex_fcaller(F.max_unpool3d, input, indices, self.kernel_size, self.stride,
                                    self.padding, output_size)
...
class AvgPool1d(_AvgPoolNd):
    ...
    def forward(self, input: Tensor) -> Tensor:
        return cF.complex_fcaller(F.avg_pool1d, input, self.kernel_size, self.stride, self.padding, self.ceil_mode,
...
class AvgPool2d(_AvgPoolNd):
    ...
    def forward(self, input: Tensor) -> Tensor:
        return cF.complex_fcaller(F.avg_pool2d, input, self.kernel_size, self.stride,
...
class AvgPool3d(_AvgPoolNd):
    ...
    def forward(self, input: Tensor) -> Tensor:
        return cF.complex_fcaller(F.avg_pool3d, input, self.kernel_size, self.stride,
                                    self.padding, self.ceil_mode, self.count_include_pad, self.divisor_override)
...
class FractionalMaxPool2d(Module):
    ...
    def __init__(self, kernel_size: _size_2_t, output_size: Optional[_size_2_t] = None,
        ...
        if self.output_ratio is not None and not (
            0 < self.output_ratio[0] < 1 and 0 < self.output_ratio[1] < 1
        ):
            raise ValueError(f"output_ratio must be between 0 and 1 (got {output_ratio})")

    def forward(self, input: Tensor) -> Tensor:
        return cF.complex_fcaller(F.fractional_max_pool2d, input, self.kernel_size, self.output_size, self.output_ratio,
                                    self.return_indices, _random_samples=self._random_samples)
...
class FractionalMaxPool3d(Module):
    ...
    def forward(self, input: Tensor) -> Tensor:
        return cF.complex_fcaller(F.fractional_max_pool3d,
...
class LPPool1d(_LPPoolNd):
    ...
    def forward(self, input: Tensor) -> Tensor:
        return cF.complex_fcaller(F.lp_pool1d, input, float(self.norm_type), self.kernel_size,
...
class LPPool2d(_LPPoolNd):
    ...
    def forward(self, input: Tensor) -> Tensor:
        return cF.complex_fcaller(F.lp_pool2d, input, float(self.norm_type), self.kernel_size,
                                    self.stride, self.ceil_mode)
...
class AdaptiveMaxPool1d(_AdaptiveMaxPoolNd):
    ...
    def forward(self, input: Tensor) -> Tensor:
        return cF.complex_fcaller(F.adaptive_max_pool1d, input, self.output_size, self.return_indices)
...
class AdaptiveMaxPool3d(_AdaptiveMaxPoolNd):
    ...
    def forward(self, input: Tensor) -> Tensor:
        return cF.complex_fcaller(F.adaptive_max_pool3d, input, self.output_size, self.return_indices)
...
class AdaptiveAvgPool1d(_AdaptiveAvgPoolNd):
    ...
    def forward(self, input: Tensor) -> Tensor:
        return cF.complex_fcaller(F.adaptive_avg_pool1d, input, self.output_size)
...
class AdaptiveAvgPool2d(_AdaptiveAvgPoolNd):
    ...
    def forward(self, input: Tensor) -> Tensor:
        return cF.complex_fcaller(F.adaptive_avg_pool2d, input, self.output_size)
...
class AdaptiveAvgPool3d(_AdaptiveAvgPoolNd):
    ...
    def forward(self, input: Tensor) -> Tensor:
        return cF.complex_fcaller(F.adaptive_avg_pool3d, input, self.output_size)
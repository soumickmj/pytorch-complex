...
class Upsample(Module):
    ...
    Args:
        ...
        mode (str, optional): the upsampling algorithm: one of ``'sinc'``, ``'nearest'`
    ...
    def __init__(self, size: Optional[_size_any_t] = None, scale_factor: Optional[_ratio_any_t] = None,
                 mode: str = 'sinc', align_corners: Optional[bool] = None) -> None:
    ...
    def forward(self, input: Tensor) -> Tensor:
        return cF.interpolate(input, self.size, self.scale_factor, self.mode, self.align_corners)
